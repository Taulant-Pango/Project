    ...
    <body>
        <div class="d-flex justify-content-center gap-5 mt-3">
            <div class="bg-light p-5">
                <h3>Edit Project</h3>
                <form:form class="form d-flex flex-column gap-3" action="/classes/${editCourse.id}/update" method="put" modelAttribute="editCourse">
                    ...
                    <td><a class="linkBtn" href="/classes">Cancel</a></td>
                    <a href="/classes/delete/${editCourse.id}">Delete</a>
